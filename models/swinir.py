...
if __name__ == '__main__':
    upscale = 4
    window_size = 8
    height = (26 // upscale // window_size + 1) * window_size
    width = (18 // upscale // window_size + 1) * window_size
    length = (23 // upscale // window_size + 1) * window_size
    model = SwinIR(upscale=2, img_size=(height, width, length),

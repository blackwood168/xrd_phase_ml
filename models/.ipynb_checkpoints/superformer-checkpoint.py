...
def window_partition(x, window_size):
    ...
    B, H, W, D, C = x.shape
    #print(x.shape)
    #print(B, H // window_size, window_size, W // window_size, window_size, D // window_size, window_size, C)
...
class SuperFormer(nn.Module):
    ...
    def __init__(self, img_size=(26,18,23), patch_size=1, in_chans=1,
                 embed_dim=1, depths=[7,7, 7, 7], num_heads=[1, 1, 1, 1],
                 window_size=1, mlp_ratio=7., qkv_bias=True, qk_scale=None,
